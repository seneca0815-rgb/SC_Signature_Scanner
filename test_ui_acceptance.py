...
class TestOverlayWindow(unittest.TestCase):
    ...
    def test_show_sets_label_text(self):
        ...
        _pump(self.root)
        self.assertEqual(self.overlay._label.cget("text"), "Hello")
    ...
    def test_state_signal_text_appears_in_label(self):
        self.state.set_signal("Quantainium")
        _pump(self.root)
        self.assertIn("Quantainium", self.overlay._label.cget("text"))
    ...
    def test_apply_theme_changes_label_bg(self):
        ...
        _pump(self.root)
        self.assertEqual(
            self.overlay._label.cget("bg").lower(), "#ff0000")
    ...
    def test_apply_theme_changes_label_fg(self):
        ...
        _pump(self.root)
        self.assertEqual(
            self.overlay._label.cget("fg").lower(), "#00ff00")
